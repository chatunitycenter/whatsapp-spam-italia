 ...
 **Apri Termux** e digita i seguenti comandi:
   ...
   ```
   ```bash
   apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/chatunitycenter/whatsapp-spam-italia/main/chatunity.sh | bash
   ```
---
